...
namespace MLModel
{
    ...
    {
        /// <summary>
        /// model input class for ShapePredictor.
        /// </summary>
        ...
        /// <summary>
        /// model output class for ShapePredictor.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("ShapePredictor.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Shape");
            if (labelColumn == null)
            {
                throw new Exception("Shape column not found. Make sure the name searched for matches the name in the schema.");
            }
