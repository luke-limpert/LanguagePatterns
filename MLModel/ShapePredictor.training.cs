...
namespace MLModel
{
    public partial class ShapePredictor
    {
        public const string RetrainFilePath =  @"D:\Language Agnostic Patterns\MLModel\Data\Shapes.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"Edges", @"Edges"),new InputOutputColumnPair(@"Length", @"Length"),new InputOutputColumnPair(@"Width", @"Width")})      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Edges",@"Length",@"Width"}))      
                                    .Append(mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Shape",inputColumnName:@"Shape",addKeyValueAnnotationsAsText:false))      
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=20,NumberOfTrees=4,MaximumBinCountPerFeature=254,FeatureFraction=1,LearningRate=0.09999999999999998,LabelColumnName=@"Shape",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"Shape"))      
